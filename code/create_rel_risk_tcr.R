...
vars = c('detection_share','detection_share_syr',	'detection_share_syr4',	'detection_share_2016',	'sample_count')
...
write.csv(all_risk, file = "ej_service_areas/data/rel_risk/rel_risk_tcr_sensitivity.csv")
