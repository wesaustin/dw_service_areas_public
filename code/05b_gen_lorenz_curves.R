...
lorenz_data <- hb_vio %>%
  ...
  mutate(cdf_poverty = (cumsum(lowinc) / sum(lowinc))*100,  # poverty share ranking
         ...
         cdf_vio = (cumsum(total_violations) / sum(total_violations))*100)  # cumulative violations exposure by pov share ranking 
...
png(file = 'ej_service_areas/output/lorenz curves/hb_lowinc_lorenz.png', 
...
png(file = 'ej_service_areas/output/lorenz curves/hb_minor_lorenz.png', 
    width = 500, height = 700, units = "px", pointsize = 12,
    bg = "white")
...
png(file = 'ej_service_areas/output/lorenz curves/lcr_lowinc_lorenz.png', 
    width = 500, height = 700, units = "px", pointsize = 12,
    bg = "white")
...
png(file = 'ej_service_areas/output/lorenz curves/lcr_minor_lorenz.png', 
    width = 500, height = 700, units = "px", pointsize = 12,
    bg = "white")
...
png(file = 'ej_service_areas/output/lorenz curves/pfas_lowinc_lorenz.png', 
    width = 500, height = 700, units = "px", pointsize = 12,
    bg = "white")
...
png(file = 'ej_service_areas/output/lorenz curves/pfas_minor_lorenz.png', 
    width = 500, height = 700, units = "px", pointsize = 12,
    bg = "white")
...
png(file = 'ej_service_areas/output/lorenz curves/dbp_lowinc_lorenz.png', 
    width = 500, height = 700, units = "px", pointsize = 12,
    bg = "white")
...
png(file = 'ej_service_areas/output/lorenz curves/dbp_minor_lorenz.png', 
    width = 500, height = 700, units = "px", pointsize = 12,
    bg = "white")
...
png(file = 'ej_service_areas/output/lorenz curves/tcr_lowinc_lorenz.png', 
    width = 500, height = 700, units = "px", pointsize = 12,
    bg = "white")
...
png(file = 'ej_service_areas/output/lorenz curves/tcr_minor_lorenz.png', 
    width = 500, height = 700, units = "px", pointsize = 12,
    bg = "white")
...
png(file = 'ej_service_areas/output/lorenz curves/ars_lowinc_lorenz.png', 
    width = 500, height = 700, units = "px", pointsize = 12,
    bg = "white")
...
png(file = 'ej_service_areas/output/lorenz curves/ars_minor_lorenz.png', 
    width = 500, height = 700, units = "px", pointsize = 12,
    bg = "white")
...
png(file = 'ej_service_areas/output/lorenz curves/nitrate_lowinc_lorenz.png', 
    width = 500, height = 700, units = "px", pointsize = 12,
    bg = "white")
...
png(file = 'ej_service_areas/output/lorenz curves/nitrate_minor_lorenz.png', 
    width = 500, height = 700, units = "px", pointsize = 12,
    bg = "white")
