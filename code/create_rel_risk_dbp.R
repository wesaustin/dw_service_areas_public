...
vars = c('haa5', 'haa5_syr3', 'haa5_syr4', 'tthm', 'tthm_syr3', 'tthm_syr4', 'combined_dbp_syr3', 'combined_dbp_syr4', 'combined_dbp')
...
write.csv(all_risk, file = "ej_service_areas/data/rel_risk/rel_risk_dbp_sensitivity.csv")
